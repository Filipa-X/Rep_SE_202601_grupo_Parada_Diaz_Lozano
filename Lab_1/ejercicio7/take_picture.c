...
static camera_config_t camera_config = {
    ...
    .frame_size = FRAMESIZE_96X96,    //QVGA, QQVGA-UXGA, For ESP32, do not use sizes above QVGA when not JPEG. The performance of the ESP32-S series has improved a lot, but JPEG mode always gives better frame rates.
